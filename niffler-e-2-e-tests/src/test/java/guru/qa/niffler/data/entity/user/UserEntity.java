...
public class UserEntity implements Serializable {
  ...
  public void addFriends(FriendshipStatus status, UserEntity... friends) {
    ...
    if (Objects.isNull(friendshipIncome)){
        friendshipIncome = new ArrayList<>();
    }
    ...
    public void addInvitations(UserEntity... invitations) {
        ...
        if (Objects.isNull(friendshipOutcome)){
            friendshipOutcome = new ArrayList<>();
        }
    ...
    public static UserEntity fromJson(UserJson json) {
        ...
        u.setPhotoSmall(json.photoSmall());
        u.setFullname(json.fullName());
